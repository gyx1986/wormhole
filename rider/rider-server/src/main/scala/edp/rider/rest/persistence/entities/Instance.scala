...
case class SimpleInstance(desc: Option[String] = None,
                          ...
                          nsInstance: String,
                          connUrl: String,
                          version: String) extends SimpleBaseEntity
...
class InstanceTable(_tableTag: Tag) extends BaseTable[Instance](_tableTag, "instance") {
  def * = (id, nsInstance, desc, nsSys, connUrl, version, active, createTime, createBy, updateTime, updateBy) <> (Instance.tupled, Instance.unapply)
  ...
  val version: Rep[Option[String]] = column[Option[String]]("version", O.Length(20, varying = true), O.Default(None))
